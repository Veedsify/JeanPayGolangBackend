...
type User struct {
	...
	GoogleCloudId      string           `json:"google_cloud_id" gorm:"default:null"`
	...
	WithdrawMethods    []WithdrawMethod `json:"withdraw_methods" gorm:"foreignKey:UserID;references:ID;constraint:OnUpdate:CASCADE,OnDelete:CASCADE"`
}
